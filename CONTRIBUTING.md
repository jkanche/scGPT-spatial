...
Welcome to `scgpt-spatial` contributor's guide.
...
If you experience bugs or general issues with `scgpt-spatial`, please have a look
...
You can help improve `scgpt-spatial` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`scgpt-spatial` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `scgpt-spatial`'s files. While this mechanism can
...
```
conda create -n scgpt-spatial python=3 six virtualenv pytest pytest-cov
conda activate scgpt-spatial
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/scgpt-spatial.git
   cd scgpt-spatial
   ```
...
5. Install [pre-commit]:
   ...
   `scgpt-spatial` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/scgpt-spatial
[issue tracker]: https://github.com/<USERNAME>/scgpt-spatial/issues
